...
export function AppSidebar() {
        ...
        <Sidebar className="z-[100] border-none" collapsible="icon">
            <SidebarContent className="bg-sidebar border-r border-sidebar-border/50">
                <div className="flex flex-col h-full">
                    ...
                    <div className={cn("flex items-center justify-center transition-all",
                        ...
                        <img
                            ...
                            className={cn("w-auto transition-all brightness-110",
                                collapsed ? "h-4" : "h-7"
                            )}
                        />
                    </div>
                    ...
                    {!collapsed && (
                        <div className="px-3 py-3">
                            {isLoading ? (
                                ...
                                >
                                    <SelectTrigger className="w-full bg-white/10 border-white/10 hover:bg-white/20 transition-colors h-8 text-xs font-medium relative z-10 rounded-lg pr-2 text-sidebar-foreground">
 ...
 ${isActive
                                        ...
                                        >
                                            ...
                                            {!collapsed && <span className="text-[10px] font-semibold">Administration</span>}
                                        </NavLink>
                                    </SidebarMenuButton>
                                </SidebarMenuItem>
                            </SidebarMenu>
                    ...
                    <div className={`p-4 mt-auto ${collapsed ? 'items-center' : ''} flex flex-col gap-3`}>
                        {!collapsed && user && (
                            <NavLink
                                to="/profile"
                                className={({ isActive }) => `px-1 flex items-center gap-2.5 rounded-xl p-2 transition-all cursor-pointer hover:bg-white/10 ${isActive ? 'bg-primary/10' : ''}`
                                }
                            >
                        ...
                        {collapsed && user && (
                            <NavLink
                                to="/profile"
                                className={({ isActive }) => `flex items-center justify-center w-8 h-8 rounded-full bg-primary text-primary-foreground text-xs font-medium mx-auto transition-all ${isActive ? 'ring-2 ring-primary/40' : ''}`
                                }
                            >
                                {user.name.charAt(0)}
                            </NavLink>
