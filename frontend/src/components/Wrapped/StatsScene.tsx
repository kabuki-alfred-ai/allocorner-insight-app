...
export const StatsScene: React.FC<{
 ...
 <span
 className="text-8xl md:text-[10rem] font-semibold tracking-tighter leading-none text-white"
 style={{
 ...
 <span
 className="text-2xl md:text-3xl font-semibold tracking-[0.3em] text-white/80"
