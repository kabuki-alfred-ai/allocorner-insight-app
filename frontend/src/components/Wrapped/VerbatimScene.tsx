...
const SingleVerbatim: React.FC<VerbatimData & { verbatimIndex?: number; totalVerbatims?: number }> = ({ 
 ...
 <p className={`${getFontSizeClass(text.length)} font-semibold text-white leading-snug tracking-tight`}>
 ...
 <span className="text-sm md:text-base font-semibold text-primary/70">
 {emotion}
 </span>
 </>
 )}
