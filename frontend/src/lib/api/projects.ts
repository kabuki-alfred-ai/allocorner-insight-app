...
export async function upsertMetrics(
 ...
 const response = await apiClient.put<ProjectMetrics>(`/projects/${projectId}/metrics`,
 data,
 );
 return response.data;
}
...
export async function upsertPlutchik(
 ...
 const response = await apiClient.put<ProjectPlutchik>(`/projects/${projectId}/plutchik`,
 data,
 );
 return response.data;
}
...
export async function uploadLogo(
 ...
 const response = await apiClient.post<Project>(`/projects/${projectId}/logo`,
 formData,
 {
 headers: {
