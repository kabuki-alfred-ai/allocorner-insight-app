...
export async function createTheme(
 ...
 const response = await apiClient.post<Theme>(`/projects/${projectId}/themes`,
 data,
 );
 return response.data;
}
...
export async function updateTheme(
 ...
 const response = await apiClient.patch<Theme>(`/projects/${projectId}/themes/${themeId}`,
 data,
 );
 return response.data;
}
...
export async function setThemeTotemMessage(
 ...
 const response = await apiClient.post<Theme>(`/projects/${projectId}/themes/${themeId}/totem`,
 { messageId },
 );
 return response.data;
}
...
export async function getAvailableMessagesForTheme(
 ...
 const response = await apiClient.get<MessageWithAssociation[]>(`/projects/${projectId}/themes/${themeId}/messages/available`,
 );
 return response.data;
}
...
export async function getMessagesByTheme(
 ...
 const response = await apiClient.get<Message[]>(`/projects/${projectId}/themes/${themeId}/messages`,
 );
 return response.data;
}
...
export async function associateMessageToTheme(
 ...
 const response = await apiClient.post<{ associated: boolean }>(`/projects/${projectId}/themes/${themeId}/messages/${messageId}`,
 );
 return response.data;
}
...
export async function dissociateMessageFromTheme(
 ...
 const response = await apiClient.delete<{ dissociated: boolean }>(`/projects/${projectId}/themes/${themeId}/messages/${messageId}`,
 );
 return response.data;
}
...
export async function associateMessagesBatch(
 ...
 const response = await apiClient.post<{ associated: number }>(`/projects/${projectId}/themes/${themeId}/messages/batch`,
 { messageIds },
 );
 return response.data;
}
