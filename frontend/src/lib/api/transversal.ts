...
export async function getTransversalAnalyses(
 ...
 const response = await apiClient.get<TransversalAnalysis[]>(`/projects/${projectId}/transversal`,
 );
...
export async function createTransversalAnalysis(
 ...
 const response = await apiClient.post<TransversalAnalysis>(`/projects/${projectId}/transversal`,
 data,
 );
 return response.data;
}
...
export async function updateTransversalAnalysis(
 ...
 const response = await apiClient.patch<TransversalAnalysis>(`/projects/${projectId}/transversal/${id}`,
 data,
 );
 return response.data;
}
...
export async function deleteTransversalAnalysis(
 ...
 await apiClient.delete(`/projects/${projectId}/transversal/${id}`,
 );
}
