...
function DynamicStringList({
 ...
 <Label className="text-[10px] font-semibold text-muted-foreground/60 ml-1">{label}</Label>
 <Button 
 type="button" 
 variant="outline" 
 size="sm" 
 onClick={handleAdd}
 className="h-8 rounded-lg text-[10px] font-medium border-primary/10 text-primary hover:bg-primary/5"
 >
...
function DynamicTrendList({
 ...
 {values.length === 0 && (
 <p className="text-[10px] font-medium text-muted-foreground/40 mt-2 ml-1">
 Aucun element.
 </p>
 )}
...
export function AdminTrendsPage() {
 ...
 <TabsTrigger 
 value="trends" 
 className="data-[state=active]:bg-transparent data-[state=active]:shadow-none data-[state=active]:border-b-2 data-[state=active]:border-primary rounded-none px-0 py-4 text-[10px] font-semibold text-muted-foreground data-[state=active]:text-primary transition-all"
 >
 Synthèse Dynamique
 </TabsTrigger>
 <TabsTrigger 
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/70">Signal faible identifié</FormLabel>
 <FormControl>
 <Input
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/70">Analyse détaillée du signal</FormLabel>
 <FormControl>
 <Textarea
 ...
 className="h-12 rounded-xl font-semibold text-xs shadow-lg shadow-primary/20 bg-primary text-primary-foreground border-none px-12"
 >
