...
export function AdminMetricsPage() {
 ...
 className="w-full h-12 rounded-xl font-semibold text-xs shadow-lg shadow-primary/20 mt-6"
 >
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Joie</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Confiance</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Tristesse</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Anticipation</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Colere</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Surprise</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Peur</FormLabel>
 <FormControl>
 <Input
 type="number"
 min={0}
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/60 ml-1">Résumé du cocktail émotionnel</FormLabel>
 <FormControl>
 <Textarea
