...
export function AdminTransversalPage() {
 ...
 <h3 className="text-lg font-semibold font-heading text-foreground/80 mb-2">Aucune analyse transversale</h3>
 ...
 <Badge variant="outline" className="text-[10px] font-semibold py-0.5 px-3 border-none bg-primary/10 text-primary rounded-lg">
 {a.axis}
 </Badge>
 <Badge variant="secondary" className="text-[10px] font-semibold py-0.5 px-3 rounded-lg bg-muted/50 text-muted-foreground/80">
 {a.category}
 </Badge>
 </div>
 ...
 <Label htmlFor="ta-axis" className="text-[10px] font-semibold text-muted-foreground/70 ml-1">Axe d'analyse *</Label>
 <Input
 id="ta-axis"
 value={form.axis}
 ...
 <div className="space-y-2">
 <Label htmlFor="ta-category" className="text-[10px] font-semibold text-muted-foreground/70 ml-1">Catégorie *</Label>
 <Input
 id="ta-category"
 value={form.category}
 onChange={(e) =>
 ...
 <div className="space-y-2">
 <Label htmlFor="ta-content" className="text-[10px] font-semibold text-muted-foreground/70 ml-1">Contenu détaillé</Label>
 <Textarea
 id="ta-content"
 value={form.content}
