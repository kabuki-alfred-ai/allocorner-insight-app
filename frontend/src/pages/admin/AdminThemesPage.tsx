...
export function AdminThemesPage() {
 ...
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80">Thème</TableHead>
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80">Analyse</TableHead>
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80">Détails</TableHead>
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80 text-center">Témoignages</TableHead>
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80 text-center">Totem</TableHead>
 <TableHead className="py-6 px-4 text-[11px] font-semibold tracking-[0.2em] text-muted-foreground/80 text-right">Actions</TableHead>
 </TableRow>
 </TableHeader>
 <TableBody>
 {themes.map((theme) => (
 ...
 <span className="text-sm font-semibold font-heading group-hover:text-primary transition-colors">
 {theme.name}
 </span>
 </TableCell>
 <TableCell className="py-4 px-4">
 <p className="text-xs font-medium text-muted-foreground/60 leading-relaxed line-clamp-2 italic max-w-sm">
 ...
 {theme.emotionLabel && (
 <Badge variant="secondary" className="bg-muted/50 text-muted-foreground border-none text-[8px] font-semibold w-fit">
 {theme.emotionLabel}
 </Badge>
 )}
 </div>
 ...
 <Badge variant="secondary" className="bg-primary/5 text-primary border-none text-[10px] font-semibold font-heading">
 {theme.count}
 </Badge>
 </TableCell>
 <TableCell className="py-4 px-4 text-center">
 {theme.totemMessageId ? (
 <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-amber-500/10 text-amber-500 border border-amber-500/20 text-[8px] font-semibold mx-auto">
