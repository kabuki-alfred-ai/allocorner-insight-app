...
export default function Themes() {
 ...
 <aside className="lg:col-span-3 sticky top-8 self-start py-2">
 <ThemeSelector
 themes={themesList}
 ...
 <section className="lg:col-span-5 px-2">
 {selectedTheme && (
 ...
 <section className="lg:col-span-4 border-l border-border/50 pl-8">
 {selectedTheme && (
 <MessageList
 theme={selectedTheme}
 onThemeSelect={setSelectedTheme}
