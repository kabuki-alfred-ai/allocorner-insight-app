...
export function ProfilePage() {
 ...
 render={({ field }) => (
 <FormItem>
 <FormLabel className="text-[10px] font-semibold text-muted-foreground/70">
 Nom complet
 </FormLabel>
 <FormControl>
 <Input
 ...
 <div className="w-10 h-10 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-sm font-medium shadow-sm shadow-primary/20">
 {user?.name.charAt(0)}
 </div>
 ...
 variant="default" className="shadow-xl shadow-primary/20 px-12 h-12 font-semibold rounded-xl border-none"
 >
 ...
 passwordMutation.mutate(data as Required<PasswordFormValues>),
 )}
 >
 <div className="p-10 space-y-8">
 <h3 className="text-xs font-semibold text-muted-foreground mb-6 flex items-center gap-2 !text-primary">
